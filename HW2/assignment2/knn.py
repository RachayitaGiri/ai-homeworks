...
from cecs551.classifiers import KNearestNeighbor
...
# 
# First, open `cecs551/classifiers/k_nearest_neighbor.py` and implement the function `compute_distances_two_loops` that uses a (very inefficient) double loop over all pairs of (test, train) examples and computes the distance matrix one element at a time.

# In[ ]:


# Open cecs551/classifiers/k_nearest_neighbor.py and implement
